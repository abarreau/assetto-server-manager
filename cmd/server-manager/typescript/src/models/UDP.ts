...
// classes
// struct2ts:github.com/abarreau/assetto-server-manager/pkg/udp.SessionInfo
class SessionInfo {
    Version: number;
    SessionIndex: number;
...
// struct2ts:github.com/abarreau/assetto-server-manager/pkg/udp.CarUpdateVec
class CarUpdateVec {
    X: number;
    Y: number;
    Z: number;
...
// struct2ts:github.com/abarreau/assetto-server-manager/pkg/udp.CarUpdate
class CarUpdate {
    CarID: number;
    Pos: CarUpdateVec;
...
// struct2ts:github.com/abarreau/assetto-server-manager/pkg/udp.LapCompletedLapCompletedCar
...
// struct2ts:github.com/abarreau/assetto-server-manager/pkg/udp.LapCompleted
class LapCompleted {
    CarID: number;
    LapTime: number;
    Cuts: number;
...
// struct2ts:github.com/abarreau/assetto-server-manager/pkg/udp.CollisionWithEnvironment
...
// struct2ts:github.com/abarreau/assetto-server-manager/pkg/udp.CollisionWithCar
...
// struct2ts:github.com/abarreau/assetto-server-manager/pkg/udp.Chat
class Chat {
    CarID: number;
    Message: string;
